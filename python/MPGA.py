...
plt.rcParams['font.family'] = 'Times New Roman'  # 设置字体为“新罗马”
...
class Pool:  # 单个种群
    ...
    def show(self):
        plt.rcParams['font.family'] = 'Times New Roman'  # 设置字体为“新罗马”
        plt.rcParams['font.size'] = 20  # 设置字体大小为 12
    ...
    def settings(self):
        return {'cls': self.rule, 'size': self.size, 'pc': self.pc, 'pm': self.pm, 'ps': self.ps, 'select': self.select,
...
class Poolsys:  # 多种群管理
    ...
    def run(self, rounds=500, end_bound=100):
        ...
        with open(log_file_path, 'w') as f:
            ...
            print(f'totalTime={totalTime} avgTime={totalTime / round_num}', file=f)
